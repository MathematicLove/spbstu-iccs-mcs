...
- Статьи:
  ...
  - [Использование компьютерного зрения для обнаружения положения вне игры в футболе](https://github.com/MathematicLove/spbstu-iccs-mcs/tree/main/articles).
- Дипломный проект: 
...
- Учеба:
  ...
  - 5-ый семестр:
    ...
    - Теория вероятности (ВЭ, СВ, ЧХСВ, ВСВ, ЦПТ, ЦМ) (**н/д**);
    - Технологии разработки программного обеспечения (**н/д**); 
